...
### [Problem](https://leetcode.com/problems/movie-rating/description/)
...
- Find the name of the user who has rated the greatest number of movies.
  In case of a tie, return the lexicographically smaller username.
...
Runtime: 1731 ms, Beats 78.77% of users with MySQL.
