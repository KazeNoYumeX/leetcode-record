...
A **high earner** in a department is an employee who has a salary in the **top three unique** salaries for that
department.
...
Runtime: 1363 ms, Beats 82.28% of users with MySQL.
